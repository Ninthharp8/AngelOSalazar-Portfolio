...
export default function SkillsSection() {
  return (
    <section
      id="skills"
      className="scroll-mt-10 py-12 bg-gradient-to-b from-background to-muted/20"
    >
      <div className="container max-w-4xl mx-auto px-6 md:px-4">
        ...
        >
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🌍</span> Idiomas
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.lenguajes.map((skill, index) => (
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">☁️</span> Nube & DevOps
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🧰</span> Herramientas & Productividad
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">💻</span> Sistemas operativos
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
